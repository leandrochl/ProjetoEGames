<%-- 
    Document   : paginaManterFornecedor
    Created on : 17/06/2016, 14:26:37
    Author     : Leandro
--%>
...
<body>
    ...
    <h3>Escolha uma ação</h3><p>
        <a href="../../cadastro/fornecedor.jsp"><img src="../../imagens/add1.png" height="80" width="80"/></a>     <!--Cliente-->
        <a href="../../listar/listagemAlteraForn.jsp"><img src="../../imagens/Data-List-icon.png" height="80" width="80"/></a> <p>
