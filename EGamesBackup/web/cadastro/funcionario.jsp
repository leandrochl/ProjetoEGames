...
<!--<html>
    ...
    <form action="crud/funcionarioCrud.jsp" method="post" name="form1" >
    ...
    <div>Senha: <input type="password" name="senhaFunc" value=""/></div><p>
    <div>Repita a senha: <input type="password" name="senhaFunc2" value=""/></div><p>
    <div>Telefone: <input type="text" name="telefone1" value=""/></div><p>
    <div>Telefone2: <input type="text" name="telefone2" value=""/></div><p>
    <div>Telefone3: <input type="text" name="telefone3" value=""/></div><p>
    ...
    <div>Numero da Carteira de Trabalho <input type="text" name="carteiraFunc" value=""/></div><p>
    <div>
...
<html>
    ...
    <form name="form_cadastro_cliente" action="crud/funcionarioCrud.jsp" method="post" name="form1" >
        &emsp;
        <div>
            <label for="fname">Nome Completo:&emsp;</label><input type="text" name="nomeFunc" value="Nome Completo">
            <p><label for="lname">Email:&emsp;</label><input type="text" name="emailFunc" value="Email"></p>
            <p><label for="lname">Endereço:&emsp;</label><input type="text" name="enderecoFunc" value="Endereço"></p>
            ...
            &emsp; 
            <input type="submit" name="crud" value="Cadastrar" onClick="return senhaFunc.equals(senhaFunc2)"/>
