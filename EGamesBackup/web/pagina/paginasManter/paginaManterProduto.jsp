<%-- 
    Document   : paginaManterProduto
    Created on : 17/06/2016, 14:26:22
    Author     : Leandro
--%>
...
<body>
    ...
    <h3>Aqui você poderá adicionar novos produtos no catálogo do sistema, além de listar os produtos já cadastrados para alterações</h3><p>
    <h3>Escolha uma ação</h3><p>
        <a href="../../cadastro/produto.jsp"><img src="../../imagens/add1.png" height="80" width="80"/></a>     <!--Cliente-->
        <a href="../../listar/listagemAlteraProduto.jsp"><img src="../../imagens/Data-List-icon.png" height="80" width="80"/></a> <p>
