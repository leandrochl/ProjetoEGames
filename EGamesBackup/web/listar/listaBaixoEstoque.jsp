<%-- 
    Document   : listaBaixoEstoque
    Created on : Jun 27, 2016, 9:13:56 PM
    Author     : evio
--%>
    ...
    <form action="listarProduto.jsp method="post" value>   
        ...
        <table border = '0' width = '100%'>
            <%
                ...
                f = fd.verificaBaixoEstoque();
                for (Produto OBJForn : f) {
            %>
            <tr width='10%'>
                <th rowspan="2" bgcolor="#894AB0"><font color="white">Foto</font></th>
                <th rowspan="2" width='10'>  <a href="listaBaixoEstoque.jsp"><img src="../imagens/cliente2.png" height="128" width="128"/></a>
